...
import { View, Text, TouchableOpacity, Modal, Pressable, TextInput, ScrollView } from 'react-native'
...
const ModalMix = (props) => {
  ...
  const [selectedCottonMix, setSelectedCottonMix] = useState();
  const [selectedViscoseMix, setSelectedViscoseMix] = useState()
  ...
  const compos = modalData.composition.map(item => item)
  //console.log(compos)
  ...
  return (
    <Modal
      ...
      <View style={{
        ...
        <View style={{
          width: '90%', marginTop: '47%',
          marginBottom: '30%', backgroundColor: 'white', justifyContent: 'center',
          alignItems: 'center', paddingBottom: 15, borderRadius: 20,
        }}>
          <ScrollView style={{
...
textAlign: 'center',}}>Hello World!</Text>*/}
          ...
          <Pressable
            style={{
              ...
              padding: 10,
              margin: 10,
              elevation: 2, backgroundColor: 'lightgrey',
            }}
            onPress={() => {
        ...
        {/*  <View style={{
            ...
            <Text style={{ fontWeight: '600' }}>% Merinos</Text>
            <Picker
              //selectedValue={selectedYarnType}
              style={{ height: 80, width: '110%', alignSelf: 'center', overflow: 'hidden' }}
              onValueChange={(itemValue, itemIndex) => {
              ...
              itemStyle={{ fontSize: 14, height: 60, fontWeight: '600', color: '#201C0C', backgroundColor: 'pink', marginTop: 5, }}>
