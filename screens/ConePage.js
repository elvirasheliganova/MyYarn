import {
  View, Text, FlatList, Image, TextInput, Pressable, ImageBackground, Keyboard,
  Alert, KeyboardAvoidingView, SafeAreaView, Platform, TouchableWithoutFeedback
} from 'react-native'
      ...
      <TouchableWithoutFeedback onPress={() => { Keyboard.dismiss() }}>
        ...
        >
          ...
          <View style={{ flex: 1, justifyContent: 'flex-end' }}>
            ...
            <View style={{ backgroundColor: '#c4d2c9', marginHorizontal: 15, padding: 10, borderRadius: 10, marginBottom: 38 }}>
              ...
              <>
                <View style={{
                  ...
                  <View style={{
                    ...
                    <View style={{
                      marginBottom: 20, flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#DCFC98',
                      //borderWidth:  1 , 
                  ...
                  <Pressable onPress={() => {
                    ...
                    {yarn.gaugeImage ? <ImageBackground source={{ uri: yarn.gaugeImage }} style={{
                      flex: 1, alignSelf: 'flex-start', shadowColor: '# 8C9284',
                      shadowOffset: { width: -2, height: -4 },
                      shadowOpacity: 0.1,
                      shadowRadius: 3,
                    }} imageStyle={{ height: 130, width: 130, borderRadius: 10, resizeMode: 'cover', }} /> : null}
                    {gaugeImage ? <ImageBackground source={{ uri: gaugeImage }} style={{
                      flex: 1, alignSelf: 'flex-start', shadowColor: '# 8C9284',
                      shadowOffset: { width: -2, height: -4 },
                      shadowOpacity: 0.1,
                      shadowRadius: 3,
                    }} imageStyle={{ height: 130, width: 130, borderRadius: 10, resizeMode: 'cover', }} >
                      {!yarn.gaugeImage ? <Pressable style={{
                        width: 15, height: 15,
                        backgroundColor: '#C7CAB6',
                        borderRadius: 5,
                        position: 'absolute',
